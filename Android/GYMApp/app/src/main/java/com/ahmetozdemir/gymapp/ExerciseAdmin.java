...
import com.ahmetozdemir.gymapp.databinding.ActivityExerciseAdminBinding;
...
public class ExerciseAdmin extends AppCompatActivity {
    private static final String API_URL = "http://212.20.147.47:7238/api/Exercise/getallexercises";
    private ExerciseAdapterAdmin exerciseAdapter;
    ...
    {
        ActivityExerciseAdminBinding binding;
        RecyclerView recyclerView;

        super.onCreate(savedInstanceState);

        binding = ActivityExerciseAdminBinding.inflate(getLayoutInflater());
        ...
        exerciseAdapter = new ExerciseAdapterAdmin(exerciseArrayList,this);
    ...
    {
        Intent intent = new Intent(ExerciseAdmin.this, ProfilePage.class);
        startActivity(intent);
    }

    public void goHome(View view)
    {
        Intent intent = new Intent(ExerciseAdmin.this, BasePage.class);
        startActivity(intent);
    }

    public void addEx(View view)
    {
        Log.e("ExerciseAdmin", "Flag");

        Intent intent = new Intent(ExerciseAdmin.this, ExerciseAddActivity.class);
        startActivity(intent);
    }
